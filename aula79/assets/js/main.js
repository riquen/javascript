class ValidaFormulario {
    ...
    senhasSaoValidas() {
        ...
        if (senha.value !== repetirSenha.value) {
            this.createError(senha, `Campos "Senha" e "Repetir a senha" precisam ser iguais.`);
            this.createError(repetirSenha, `Campos "Senha" e "Repetir a senha" precisam ser iguais.`);
            valid = false;
        }
